...
import HotelCard from '../ProductCard/ServiceCard.cra';
const LoadMore = ({
  handleLoadMore,
  showButton,
  buttonText,
...
export default function SectionGridService({
  data = [],
  totalItem,
  limit,
  columnWidth,
...
SectionGridService.defaultProps = {
  rowStyle: {
    flexBox: true,
    flexWrap: 'wrap',
