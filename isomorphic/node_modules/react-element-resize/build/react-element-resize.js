...
function (_React$Component) {
  ...
  function ReactElementResize(props) {
    ...
    if (_onResize) {
      _this.onResizeDebounced = debounceTimeout > -1 ? lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(_this.onResize, debounceTimeout, debounceOptions) : _this.onResize;
    }

    if (_onScroll) {
      _this.onScrollDebounced = debounceTimeout > -1 ? lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(_this.onScroll, debounceTimeout, debounceOptions) : _this.onScroll;
    }
  ...
  _createClass(ReactElementResize, [{
    ...
    value: function render() {
      ...
      }, props), onResize ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("iframe", {
