**Please note:** We are just publishing this forked version of ![Google-js-info-bubble](https://github.com/googlemaps/js-info-bubble/) into npm to use it in our docker image. For more information please check the below section.

This repository is not currently maintained, and is kept for historical purpose only.
